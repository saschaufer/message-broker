package de.saschaufer.message_broker.app.broker.config.validator;
...
public class PathValidator implements ConstraintValidator<de.saschaufer.message_broker.app.broker.config.validator.Path, Path> {
    private boolean nullable;
    private boolean directory;
    private String[] allowedFileTypes;

    @Override
    public void initialize(final de.saschaufer.message_broker.app.broker.config.validator.Path constraintAnnotation) {
