...
class E2ETest {
    ...
    static class TestConfig {
        ...
        FileStorageService fileStorageService() {
            return new FileStorageService(tempDir);
        }
    ...
    private class Call implements Callable<String> {
        ...
        private ResponseEntity<FileUploadResponse> uploadFiles() {
            ...
            return restTemplate.exchange(Router.FILE_STORAGE_PATH_V1, HttpMethod.POST, requestEntity, FileUploadResponse.class);
        }
        ...
        private ResponseEntity<String> downloadFiles(final FileUploadResponse fileUploadResponse) {
            ...
            return restTemplate.exchange(Router.FILE_STORAGE_PATH_V1, HttpMethod.GET, requestEntity, String.class);
        }
    }
}
